			      ...
			      <ul class="rslides" id="slider4">
			        ...
			        <li>
			          ...
			          <div class="caption text-center" style="color: #555;">
      					...
      					<button class="action-btn" onclick="window.location='tutorials.php';">Tutorials</button>

      					<button class="action-btn" onclick="window.location='quizzes.php';">Quizzes</button>
		
      					<button class="action-btn" onclick="window.location='subjects.php';">Subjects</button>

      					<button class="action-btn" onclick="window.location='courses.php';">Courses</button>
