...
$t=$_REQUEST[t];
	...
	$query="SELECT * FROM tutorials WHERE subject_id=".$s." AND id=".$_REQUEST[t];
			        ...
			        <li>
			          ...
			          <div class="caption text-center" style="color: #555;">
			          		...
			          		<?php
			          			...
			          			$next_id=$_SESSION['Tutorials'][$next_index];

			          			if($_SESSION['Tutorials'][$next_index]){
			          		?>
			          		<div class="col-md-12" align="center" style="padding-top: 40px;">
								<a href="learn_tutorial.php?s=<?=$s;?>&t=<?= $next_id;?>&index=<?=$next_index;?>" style="color: #111;font-family: Arial;font-size: 17px;cursor: pointer;">Next tutorial</a>	
			          		</div>
			          		<?php
			          			}
			          		?>
			          		...
			          		?>
			          		<div class="col-md-12" align="center" style="padding-top: 40px;">
								<a href="start.php?s=<?=$s;?>" style="color: #111;font-family: Arial;font-size: 17px;cursor: pointer;">End tutorial</a>	
			          		</div>
			          		<?php
			          			}
			          		?>
